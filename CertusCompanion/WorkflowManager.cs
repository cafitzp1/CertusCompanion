...
#region Analysts
        ...
        private void PopulateDynamic()
        {
            ...
            // --- SEARCH TBX --- //
            //searchTbxACS = new AutoCompleteStringCollection();

            //searchTbxACS.AddRange(CompanyNamesSubSource.ToArray());
            //searchTbxACS.AddRange(CertificateNamesSubSource.ToArray());
            //searchTbxACS.AddRange(SenderEmailsSubSource.ToArray());

            //searchTbx.AutoCompleteMode = AutoCompleteMode.Append;
            //searchTbx.AutoCompleteCustomSource = searchTbxACS;
            //searchTbx.AutoCompleteSource = AutoCompleteSource.CustomSource;
        }
...
#region Generate Form
        ...
        private void lvFiltersBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                FiltersFormIns = new FiltersForm(CurrentFilter, ColorsDataSource, AnalystNamesSubSource, StatusesDataSource, CompanyNamesSubSource, SenderEmailsSubSource);
                FiltersFormIns.PopulateCurrentFilter();
            }
            else
            {
                FiltersFormIns = new FiltersForm(ColorsDataSource,AnalystNamesSubSource,StatusesDataSource,CompanyNamesSubSource,SenderEmailsSubSource);
            }
        ...
        {
            this.splitContainerChild1.SplitterDistance = splitContainerChild1.Bottom - 412; //835 was the original here and 458 for split distance 1
...
#region Generate Form
    ...
    toolStripStatusLabel.Text = "Ready";
        ...
        private void PopulateImportViewData(CSVImport itemImport)
        {
            ...
            this.importFileNameTbx.Text = itemImport.FilePath;
...
";
            ...
            foreach (DataRow row in table.Rows)
            {
                ...
                (
                    ...
                    vendorName,
                    vendorID,
                    null, // need to add client id here when it's included in the script
                    null,
                    null,
                    null,
                    null,
